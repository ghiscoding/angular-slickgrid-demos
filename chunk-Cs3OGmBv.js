import {m as mh}from'./chunk-iymBLPps.js';import {c as c$1}from'./chunk-Bpt3EHGf.js';import {A as Ao,a1 as PP,a0 as OB,e as Tu,M as MM,X as XN,f as LB,a2 as te$1,_ as _I,j as j1,E as En,a5 as bn,a6 as An,a7 as Mn,a8 as rt,G as Cn,a9 as Vn,I as qt,aa as Ht,u as ui,q as qE,p as pp,c as cp,T as Tc,ab as XI,W as Wy,ac as eE,a as ap,V as sE,J as Rp,ad as JI,O as Lv,h as pE,ae as YE,P as Ap,Q as jv,N as Np,Z as Kl,S as QE,$ as Jl}from'./main-MR3B775B.js';import {Z as Ze}from'./chunk-SWBuXIHG.js';function Z(m,b){if(m&1&&(qE(0,`
  ...
  `),ui(26,"div",8),qE(27,`
    `),ui(28,"ul"),qE(29,`
      `),ui(30,"li"),qE(31,`
        `),ui(32,"a",9),qE(33,"Wiki docs"),Tc(),qE(34,`
      `),Tc(),qE(35,`
      `),ui(36,"li"),qE(37,"This example shows 3 ways of grouping"),Tc(),qE(38,`
      `),ui(39,"ol"),qE(40,`
        `),ui(41,"li"),qE(42,`
          ...
          drop area).
        `),Tc(),qE(43,`
        `),ui(44,"li"),qE(45,"Use buttons and defined functions to group by wichever field you want"),Tc(),qE(46,`
        `),ui(47,"li"),qE(48,"Use the Select dropdown to group, the position of the Selects represent the grouping level"),Tc(),qE(49,`
      `),Tc(),qE(50,`
      `),ui(51,"li"),qE(52,"Fully dynamic and interactive multi-level grouping with filtering and aggregates ovor 50'000 items"),Tc(),qE(53,`
      `),ui(54,"li"),qE(55,"Each grouping level can have its own aggregates (over child rows, child groups, or all descendant rows).."),Tc(),qE(56,`
      `),ui(57,"li"),qE(58,'Use "Aggregators" and "GroupTotalFormatters" directly from Angular-Slickgrid'),Tc(),qE(59,`
    `),Tc(),qE(60,`
  `),Tc(),qE(61,`
  ...
  `),ui(62,"form",10),qE(63,`
    `),ui(64,"div",11),qE(65,`
      `),ui(66,"div",12),qE(67,`
        `),ui(68,"button",13),pp("click",function(){return n.loadData(5e3)}),qE(69,"5K rows"),Tc(),qE(70,`
        `),ui(71,"button",14),pp("click",function(){return n.loadData(5e4)}),qE(72,"50K rows"),Tc(),qE(73,`
        `),ui(74,"button",15),pp("click",function(){return n.clearGroupsAndSelects()}),qE(75,`
          `),cp(76,"i",16),qE(77,` Clear grouping
        `),Tc(),qE(78,`
        `),ui(79,"button",17),pp("click",function(){return n.collapseAllGroups()}),qE(80,`
          `),cp(81,"i",18),qE(82,` Collapse all groups
        `),Tc(),qE(83,`
        `),ui(84,"button",19),pp("click",function(){return n.expandAllGroups()}),qE(85,`
          `),cp(86,"i",20),qE(87,` Expand all groups
        `),Tc(),qE(88,`
        `),ui(89,"button",21),pp("click",function(){return n.toggleDraggableGroupingRow()}),qE(90,`
          Toggle Draggable Grouping Row
        `),Tc(),qE(91,`
        `),ui(92,"button",21),pp("click",function(){return n.exportToExcel()}),qE(93,`
          `),cp(94,"i",22),qE(95,` Export to Excel
        `),Tc(),qE(96,`
        `),ui(97,"button",21),pp("click",function(){return n.exportToPdf()}),qE(98,`
          `),cp(99,"i",23),qE(100,` Export to PDF
        `),Tc(),qE(101,`
      `),Tc(),qE(102,`
    `),Tc(),qE(103,`
    `),ui(104,"div",11),qE(105,`
      `),ui(106,"div",12),qE(107,`
        `),ui(108,"button",24),pp("click",function(){return n.groupByDurationOrderByCount(false)}),qE(109,`
          Group by duration & sort groups by value
        `),Tc(),qE(110,`
        `),ui(111,"button",25),pp("click",function(){return n.groupByDurationOrderByCount(true)}),qE(112,`
          Group by duration & sort groups by count
        `),Tc(),qE(113,`
        `),ui(114,"button",26),pp("click",function(){return n.groupByDurationEffortDriven()}),qE(115,`
          Group by Duration & then Effort-Driven
        `),Tc(),qE(116,`
        `),ui(117,"button",27),pp("click",function(){return n.setFiltersDynamically()}),qE(118,`
          `),cp(119,"span",28),qE(120,`
          `),ui(121,"span"),qE(122," Set Filters Dynamically "),Tc(),qE(123,`
        `),Tc(),qE(124,`
        `),ui(125,"button",29),pp("click",function(){return n.setSortingDynamically()}),qE(126,`
          `),cp(127,"span",30),qE(128,`
          `),ui(129,"span"),qE(130," Set Sorting Dynamically "),Tc(),qE(131,`
        `),Tc(),qE(132,`
      `),Tc(),qE(133,`
    `),Tc(),qE(134,`
    `),ui(135,"div",31),qE(136,`
      `),ui(137,"div",12),qE(138,`
        `),ui(139,"div",32),qE(140,`
          `),ui(141,"div",33),qE(142,`
            `),ui(143,"label",34),qE(144,"Group by field(s)"),Tc(),qE(145,`
            `),XI(146,ee,11,3,null,null,n.selectTrackByFn,true),Tc(),qE(148,`
        `),Tc(),qE(149,`
      `),Tc(),qE(150,`
    `),Tc(),qE(151,`
  `),Tc(),qE(152,`
  `),ui(153,"div",35),qE(154,`
    `),cp(155,"hr"),qE(156,`
  `),Tc(),qE(157,`

  `),ui(158,"angular-slickgrid",36),pp("onCellChange",function(){return n.onCellChanged()})("onAngularGridCreated",function(d){return n.angularGridReady(d.detail)}),qE(159,`
  `),Tc(),qE(160,`
`),Tc(),qE(161,`
`)),o&2&&(Wy(146),eE(n.selectedGroupingFields()),Wy(12),ap("dataset",n.dataset)("columns",n.columns)("options",n.gridOptions));},dependencies:[j1,En,bn,An,Mn,rt,Cn,Vn,qt,Ht],encapsulation:2});}}return m})();export{ue as Example18Component};