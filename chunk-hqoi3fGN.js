import {S}from'./chunk-BHP64rgi.js';import {f as Tu,X as XN,aD as f,z as Te,a1 as PP,g as LB,a2 as te,b as bI,j as j1,u as ui,U as UE,c as cp,T as Tc,p as pp,W as Wy,d as ap}from'./main-WTCLCICA.js';var M=4e3,$=(()=>{class p{constructor(){this.columns=[],this.dataset=[],this.hideSubTitle=false;}angularGridReady(n){this.angularGrid=n;}ngOnInit(){this.prepareGrid(),this.dataset=this.loadData(M);}prepareGrid(){this.columns=[{id:"title",name:"Title",field:"title",sortable:true,filterable:true,minWidth:100,header:{menu:{commandItems:[{command:"sort-asc",title:"Sort Ascending",positionOrder:50,slotRenderer:n=>`
  ...
  `),ui(18,"div",6),UE(19,`
    `),ui(20,"h5",7),UE(21,`
      `),cp(22,"span",8),UE(23,`
      `),ui(24,"strong"),UE(25,"Menu Slots Demo with Custom Renderer"),Tc(),UE(26,`
    `),Tc(),UE(27,`
    `),ui(28,"p",7),UE(29,`
      Click on the menu buttons to see the new `),ui(30,"strong"),UE(31,"single slot functionality"),Tc(),UE(32,` working across all menu types (Header Menu, Cell
      Menu, Context Menu, Grid Menu):
    `),Tc(),UE(33,`
    `),ui(34,"p",9),UE(35,`
      `),ui(36,"small")(37,"strong"),UE(38,"Note:"),Tc(),UE(39," The demo focuses on the custom rendering capability via "),ui(40,"code"),UE(41,"slotRenderer"),Tc(),UE(42,` and
        `),ui(43,"code"),UE(44,"defaultMenuItemRenderer"),Tc(),UE(45,`, which work across all menu plugins (SlickHeaderMenu, SlickCellMenu, SlickContextMenu,
        SlickGridMenu). Also note that the keyboard shortcuts displayed in the menus (e.g., `),ui(46,"code"),UE(47,"Alt+\u2191"),Tc(),UE(48,", "),ui(49,"code"),UE(50,"F5"),Tc(),UE(51,`) are for
        demo purposes only and do not actually trigger any actions.
      `),Tc(),UE(52,`
    `),Tc(),UE(53,`
  `),Tc(),UE(54,`

  `),ui(55,"section",10),UE(56,`
    `),ui(57,"div",11),UE(58,`
      `),ui(59,"button",12),pp("click",function(){return i.clearGrouping()}),UE(60,`
        `),ui(61,"span"),UE(62,"Clear grouping"),Tc(),UE(63,`
      `),Tc(),UE(64,`
      `),ui(65,"button",13),pp("click",function(){return i.collapseAllGroups()}),UE(66,`
        `),cp(67,"span",14),UE(68,`
        `),ui(69,"span"),UE(70,"Collapse all groups"),Tc(),UE(71,`
      `),Tc(),UE(72,`
      `),ui(73,"button",15),pp("click",function(){return i.expandAllGroups()}),UE(74,`
        `),cp(75,"span",16),UE(76,`
        `),ui(77,"span"),UE(78,"Expand all groups"),Tc(),UE(79,`
      `),Tc(),UE(80,`
      `),ui(81,"button",17),pp("click",function(){return i.groupByDuration()}),UE(82,`
        Group by Duration
      `),Tc(),UE(83,`
    `),Tc(),UE(84,`
  `),Tc(),UE(85,`

  `),ui(86,"angular-slickgrid",18),pp("onAngularGridCreated",function(s){return i.angularGridReady(s.detail)}),UE(87,`
  `),Tc(),UE(88,`
`),Tc(),UE(89,`
