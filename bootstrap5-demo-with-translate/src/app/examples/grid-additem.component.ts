...
export class GridAddItemComponent implements OnInit {
  ...
  <ul>
    ...
    <ul>
      <li>Example, click on button "Highlight Rows with Duration over 40" to see row styling changing. <a href="https://github.com/slickclub/Angular-Slickgrid/wiki/Dynamically-Add-CSS-Classes-to-Item-Rows" target="_blank">Wiki doc</a></li>
    </ul>
  </ul>
  `;
