import{a as F,b as O}from"./chunk-TPPU4ZY2.js";import{b as S,c as C,f as _,h as P,o as k}from"./chunk-ZTHMMPCT.js";import{Da as B,n as W,p as G,wa as x,ya as v,za as p}from"./chunk-IBXCHNN7.js";import{Aa as d,Jb as w,Kb as e,Lb as u,Mb as I,Pa as b,Pb as h,Qb as g,Rb as f,Tb as V,_b as E,ac as y,db as M,eb as R,ib as T,jb as n,kb as t,lb as c,vb as m,xb as A}from"./chunk-XXRVAQWA.js";import"./chunk-PRARYYF3.js";var N=(()=>{class s{constructor(){this.model={}}alertAssignee(l){alert(typeof l=="string"?`Assignee on this task is: ${l.toUpperCase()}`:"No one is assigned to this task.")}deleteRow(l){confirm(`Are you sure that you want to delete ${l.title}?`)&&(this.addon.collapseAll(),this.dataView.deleteItem(l.rowId),this.parentRef.showFlashMessage(`Deleted row with ${l.title}`,"danger"))}callParentMethod(l){this.parentRef.showFlashMessage(`We just called Parent Method from the Row Detail Child Component on ${l.title}`)}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=b({type:s,selectors:[["ng-component"]],decls:95,vars:18,consts:[[1,"container-fluid"],[1,"row"],[1,"col-3","detail-label"],[1,"form-control",3,"ngModelChange","ngModel"],[1,"col-sm-8"],["data-test","assignee-btn",1,"btn","btn-primary","btn-sm",3,"click"],[1,"col-sm-4"],["data-test","delete-btn",1,"btn","btn-primary","btn-danger","btn-sm",3,"click"],["data-test","parent-btn",1,"btn","btn-outline-secondary","btn-sm","btn-icon",3,"click"]],template:function(a,i){a&1&&(n(0,"div",0),e(1,`
  ...
  `),n(42,"div",1),e(43,`
    ...
    `),t(),e(63,`
    `),n(64,"div",2)(65,"label"),e(66,"Effort Driven:"),t(),e(67," "),c(68,"i"),t(),e(69,`
  `),t(),e(70,`
...
`)),a&2&&(d(3),u(i.model==null?null:i.model.title),d(8),h("ngModel",i.model.assignee),d(8),u(i.model==null?null:i.model.reporter),d(9),u(y(29,9,i.model==null?null:i.model.duration,"1.2-2")),d(10),u(i.model==null?null:i.model.percentComplete),d(12),u(y(51,12,i.model==null?null:i.model.start,"yyyy-MM-dd")),d(10),u(y(61,15,i.model==null?null:i.model.finish,"yyyy-MM-dd")),d(8),w(i.model!=null&&i.model.effortDriven?"mdi mdi-check":""))},dependencies:[k,S,C,_,W,G],styles:[".detail-label[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:4px;padding:4px}","label[_ngcontent-%COMP%]{font-weight:600}"]})}}return s})();function z(s,j){if(s&1&&(e(0,`
  ...
  `),t(),e(77,`
`),t(),e(78,`
`)),a&2&&(d(59),h("ngModel",i.detailViewRowCount),d(8),h("ngModel",i.serverWaitDelay),d(4),R(i.message?71:-1),d(4),T("columns",i.columnDefinitions)("options",i.gridOptions)("dataset",i.dataset))},dependencies:[B,k,S,P,C,_],encapsulation:2})}}return s})();export{te as Example19Component};
