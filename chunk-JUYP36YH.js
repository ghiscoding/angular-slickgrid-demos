import{a as ee}from"./chunk-UZNVETKF.js";import{b as j,c as U,f as Y,h as Z,o as $}from"./chunk-RTDMW7EF.js";import{c as V}from"./chunk-AZTSUOD3.js";import{Ca as X,Da as q,n as K,u as J,wa as w}from"./chunk-RHHPLF4T.js";import{$b as H,Ib as M,Jb as e,Kb as v,Lb as T,Oa as z,Ob as B,Pb as Q,Qb as P,U as k,Zb as O,cb as R,db as F,hb as E,ia as x,ib as i,jb as n,kb as h,ub as b,wa as N,wb as W,za as m}from"./chunk-CCOLL5XZ.js";import{a as D}from"./chunk-PRARYYF3.js";function oe(p,me){if(p&1&&(e(0,`
        `),i(1,"div",25),e(2,`
  ...
  `),n(),e(111,`
`),n(),e(112,`
`)),r&2){let l,s;m(49),M((l=a.status())==null?null:l.class),m(4),T(" ",(s=a.status())==null?null:s.text,`
        `),m(),E("hidden",!a.processing()),m(18),B("ngModel",a.serverWaitDelay),m(17),T(`
            `,a.selectedLanguage()+".json",`
          `),m(6),F(a.metrics()?95:-1),m(9),E("innerHTML",a.graphqlQuery,N),m(5),E("columns",a.columnDefinitions)("options",a.gridOptions)("dataset",a.dataset)}},dependencies:[q,$,j,Z,U,Y,K],styles:[`.demo39 .badge{display:none}.demo39 .badge.fully-loaded{display:inline-flex}
