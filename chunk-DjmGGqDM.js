import {D,aj as hp,e as Tu,X as XN,_ as _I,j as j1,E as En,z as je,G as Cn,I as qt,u as ui,q as qE,c as cp,T as Tc,p as pp,J as Rp,O as Lv,W as Wy,P as Ap,Q as jv,a as ap,ak as eD,b9 as dr,C as Cc,b as bc,al as hp$1,l as lp,i as Nc,N as Np,R as RE,bi as nD,S as QE}from'./main-MR3B775B.js';var S=s=>({disabled:s}),U=(()=>{class s{constructor(){this.elm=D(dr),this._subscriptions=[],this.currentPagination={};}init(n,r,e){this._grid=n,this._paginationService=r,this._pubSubService=e,this.currentPagination=this._paginationService.getFullPagination(),this._subscriptions.push(this._pubSubService.subscribe("onPaginationRefreshed",o=>{this.currentPagination.dataFrom=o.dataFrom,this.currentPagination.dataTo=o.dataTo,this.currentPagination.pageCount=o.pageCount,this.currentPagination.pageNumber=o.pageNumber,this.currentPagination.pageSize=o.pageSize,this.currentPagination.pageSizes=o.pageSizes,this.currentPagination.totalItems=o.totalItems;}));}dispose(){this._pubSubService.unsubscribeAll(this._subscriptions),this.disposeElement();}disposeElement(){this._paginationElement.remove();}renderPagination(n,r="top"){this._gridContainerElm=n,this._paginationElement=this.elm.nativeElement,this._paginationElement.id="pager",this._paginationElement.className=`pagination-container pager ${this._grid.getUID()}`,this._paginationElement.style.width="100%",r==="top"?(this._paginationElement.classList.add("top"),n.prepend(this._paginationElement)):(this._paginationElement.classList.add("bottom"),n.appendChild(this._paginationElement));}onFirstPageClicked(n){this.isLeftPaginationDisabled()||this._paginationService.goToFirstPage(n);}onLastPageClicked(n){this.isRightPaginationDisabled()||this._paginationService.goToLastPage(n);}onNextPageClicked(n){this.isRightPaginationDisabled()||this._paginationService.goToNextPage(n);}onPreviousPageClicked(n){this.isLeftPaginationDisabled()||this._paginationService.goToPreviousPage(n);}isLeftPaginationDisabled(){return this.currentPagination.pageNumber===1||this.currentPagination.totalItems===0}isRightPaginationDisabled(){return this.currentPagination.pageNumber===this.currentPagination.pageCount||this.currentPagination.totalItems===0}static{this.\u0275fac=function(r){return new(r||s)};}static{this.\u0275cmp=_I({type:s,selectors:[["ng-component"]],decls:74,vars:21,consts:[[1,"custom-pagination"],[1,"custom-pagination-settings"],[1,"custom-pagination-count"],[1,"page-info-from-to"],["aria-label","Page Item From","data-test","item-from",1,"item-from"],["aria-label","Page Item To","data-test","item-to",1,"item-to"],[1,"page-info-total-items"],["aria-label","Total Items","data-test","total-items",1,"total-items"],[1,"text-items"],[1,"custom-pagination-nav"],["aria-label","Page navigation"],[1,"custom-pagination-ul"],[1,"li","page-item","seek-first"],["aria-label","First Page","role","button",1,"pagination-link","mdi","mdi-page-first","icon-seek-first","font-22px",3,"click"],[1,"li","page-item","seek-prev"],["aria-label","Previous Page","role","button",1,"pagination-link","icon-seek-prev","mdi","mdi-chevron-down","font-22px","mdi-rotate-90",3,"click"],[1,"page-number"],[1,"text-page"],["aria-label","Page Number","data-test","page-number-label",1,"page-number"],["data-test","page-count",1,"page-count"],[1,"li","page-item","seek-next",3,"click"],["aria-label","Next Page","role","button",1,"pagination-link","icon-seek-next","mdi","mdi-chevron-down","font-22px","mdi-rotate-270"],[1,"li","page-item","seek-end"],["aria-label","Last Page","role","button",1,"pagination-link","icon-seek-end","mdi","mdi-page-last","font-22px",3,"click"]],template:function(r,e){r&1&&(Cc(0,"div",0),qE(1,`
  ...
  `),Cc(26,"div",9),qE(27,`
    `),Cc(28,"nav",10),qE(29,`
      `),Cc(30,"ul",11),qE(31,`
        `),Cc(32,"li",12),qE(33,`
          `),Cc(34,"a",13),hp$1("click",function(l){return e.onFirstPageClicked(l)}),bc(),qE(35,`
        `),bc(),qE(36,`
        `),Cc(37,"li",14),qE(38,`
          `),Cc(39,"a",15),hp$1("click",function(l){return e.onPreviousPageClicked(l)}),bc(),qE(40,`
        `),bc(),qE(41,`
      `),bc(),qE(42,`
    `),bc(),qE(43,`
    `),Cc(44,"div",16),qE(45,`
      `),Cc(46,"span",17),qE(47,"Page"),bc(),qE(48,`
      `),Cc(49,"span",18),qE(50),bc(),qE(51,`
      of
      `),Cc(52,"span",19),qE(53),bc(),qE(54,`
    `),bc(),qE(55,`
    `),Cc(56,"nav",10),qE(57,`
      `),Cc(58,"ul",11),qE(59,`
        `),Cc(60,"li",20),hp$1("click",function(l){return e.onNextPageClicked(l)}),qE(61,`
          `),lp(62,"a",21),qE(63,`
        `),bc(),qE(64,`
        `),Cc(65,"li",22),qE(66,`
          `),Cc(67,"a",23),hp$1("click",function(l){return e.onLastPageClicked(l)}),bc(),qE(68,`
        `),bc(),qE(69,`
      `),bc(),qE(70,`
    `),bc(),qE(71,`
  `),bc(),qE(72,`
...
`)),r&2&&(Wy(9),Nc(" ",e.currentPagination?.dataFrom," "),Wy(3),Nc(`
  ...
  `),ui(2,"h2"),qE(3,`
    ...
    `),ui(4,"span",1),qE(5,`
      ...
      `),Tc(),qE(10,`
    `),Tc(),qE(11,`
    `),ui(12,"button",4),pp("click",function(){return e.toggleSubTitle()}),qE(13,`
      `),cp(14,"span",5),qE(15,`
    `),Tc(),qE(16,`
  `),Tc(),qE(17,`

  `),ui(18,"div",6),qE(19,`
    You can create a Custom Pagination by passing an Angular Custom Component and it must `),ui(20,"code"),qE(21,"implements BasePaginationComponent"),Tc(),qE(22,`.
  ...
  `),ui(24,"div"),qE(25,`
    `),ui(26,"button",7),pp("click",function(){return e.togglePaginationPosition()}),qE(27,`
      `),cp(28,"span",8),qE(29,`
      `),ui(30,"span"),qE(31,"Toggle Pagination Position"),Tc(),qE(32,`
    `),Tc(),qE(33,`

    `),ui(34,"span",9),qE(35,`
      Page Size
      `),ui(36,"input",10),Rp("ngModelChange",function(l){return QE(e.pageSize,l)||(e.pageSize=l),l}),pp("ngModelChange",function(l){return e.setPaginationSize(l)}),Tc(),Lv(),qE(37,`
    `),Tc(),qE(38,`
  `),Tc(),qE(39,`

  `),ui(40,"angular-slickgrid",11),pp("onAngularGridCreated",function(l){return e.angularGridReady(l.detail)}),qE(41,`
  `),Tc(),qE(42,`
`),Tc(),qE(43,`
