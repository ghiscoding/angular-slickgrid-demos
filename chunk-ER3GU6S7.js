import{a as w}from"./chunk-RE2W7GLJ.js";import{Da as y,J as r,T as k,ga as v,ja as E,wa as x,xa as f,za as b}from"./chunk-S4VDFSM4.js";import{Jb as t,Oa as h,hb as C,ib as a,jb as o,kb as u,ub as m,za as g}from"./chunk-CCOLL5XZ.js";import"./chunk-PRARYYF3.js";var D=2e3,$=(()=>{class p{constructor(){this.columnDefinitions=[],this.dataset=[],this.hideSubTitle=!1}angularGridReady(n){this.angularGrid=n}ngOnInit(){this.prepareGrid(),this.dataset=this.loadData(D)}prepareGrid(){this.columnDefinitions=[{id:"title",name:"Title",field:"title",sortable:!0,filterable:!0,minWidth:100,header:{menu:{commandItems:[{command:"sort-asc",title:"Sort Ascending",positionOrder:50,slotRenderer:n=>`
                  <div class="menu-item">
