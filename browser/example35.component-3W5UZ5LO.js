...
`),i(),e(90,`
`)),l&2&&(g(75),k(a.selectedLanguage()+".json"),g(3),C(a.statusClass()),g(5),w("textContent",a.fetchResult()),g(5),w("columns",a.columnDefinitions)("options",a.gridOptions)("dataset",a.dataset))},dependencies:[B],styles:[`.alert{padding:8px;margin-bottom:10px}.status-container{min-height:50px}
/*# sourceMappingURL=example35.component-3OOFDCWV.css.map */
`],encapsulation:2})}}return m})();function M(m,R){return new Promise(n=>{setTimeout(()=>{n(new Response(JSON.stringify({status:200,message:"success"})))},window.Cypress?10:500)})}export{A as Example35Component};
//# sourceMappingURL=example35.component-3W5UZ5LO.js.map
