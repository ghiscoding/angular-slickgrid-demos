import{a as P,b as F}from"./chunk-4J2BKDF5.js";import{b as S,c as C,f as _,h as O,o as k}from"./chunk-3N25H53U.js";import{Da as B,n as V,p as G,wa as x,ya as M,za as u}from"./chunk-37LE67SH.js";import{Aa as d,Jb as w,Kb as e,Lb as c,Mb as W,Pa as b,Pb as h,Qb as g,Rb as f,Tb as I,_b as E,ac as y,db as v,eb as R,ib as T,jb as n,kb as t,lb as p,vb as m,xb as A}from"./chunk-M6IC3X47.js";import"./chunk-JQGRFILQ.js";var N=(()=>{class s{constructor(){this.model={}}alertAssignee(l){alert(typeof l=="string"?`Assignee on this task is: ${l.toUpperCase()}`:"No one is assigned to this task.")}deleteRow(l){confirm(`Are you sure that you want to delete ${l.title}?`)&&(this.addon.collapseAll(),this.dataView.deleteItem(l.rowId),this.parentRef.showFlashMessage(`Deleted row with ${l.title}`,"danger"))}callParentMethod(l){this.parentRef.showFlashMessage(`We just called Parent Method from the Row Detail Child Component on ${l.title}`)}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=b({type:s,selectors:[["ng-component"]],decls:95,vars:18,consts:[[1,"container-fluid"],[1,"row"],[1,"col-3","detail-label"],[1,"form-control",3,"ngModelChange","ngModel"],[1,"col-sm-8"],["data-test","assignee-btn",1,"btn","btn-primary","btn-sm",3,"click"],[1,"col-sm-4"],["data-test","delete-btn",1,"btn","btn-primary","btn-danger","btn-sm",3,"click"],["data-test","parent-btn",1,"btn","btn-outline-secondary","btn-sm","btn-icon",3,"click"]],template:function(a,i){a&1&&(n(0,"div",0),e(1,`
  ...
  `),n(42,"div",1),e(43,`
    ...
    `),t(),e(63,`
    `),n(64,"div",2)(65,"label"),e(66,"Effort Driven:"),t(),e(67," "),p(68,"i"),t(),e(69,`
  `),t(),e(70,`
...
/*# sourceMappingURL=example19-rowdetail.component-OTOWMYGJ.css.map */`]})}}return s})();function J(s,U){if(s&1&&(e(0,`
  ...
  `),t(),e(77,`
`),t(),e(78,`
`)),a&2&&(d(59),h("ngModel",i.detailViewRowCount),d(8),h("ngModel",i.serverWaitDelay),d(4),R(i.message?71:-1),d(4),T("columns",i.columnDefinitions)("options",i.gridOptions)("dataset",i.dataset))},dependencies:[B,k,S,O,C,_],encapsulation:2})}}return s})();export{te as Example19Component};
//# sourceMappingURL=example19.component-U3DLM55U.js.map
