import{Da as v}from"./chunk-37LE67SH.js";import{Aa as p,Kb as e,Pa as y,ib as b,jb as i,kb as n,lb as u,vb as c}from"./chunk-M6IC3X47.js";import{a as x,b as C}from"./chunk-JQGRFILQ.js";var h={},g={},k=(()=>{class m{constructor(){this.columnDefinitions1=[],this.columnDefinitions2=[],this.dataset1=[],this.dataset2=[],this.hideSubTitle=!1,h={},g={}}ngOnInit(){this.defineGrid(),this.dataset1=this.loadData(200,1),this.dataset2=this.loadData(200,2)}angularGrid1Ready(l){this.angularGrid1=l}angularGrid2Ready(l){this.angularGrid2=l}defineGrid(){this.gridOptions1={enableAutoResize:!0,enableHeaderButton:!0,enableHeaderMenu:!1,autoResize:{container:"#demo-container",rightPadding:10},enableFiltering:!1,enableExcelCopyBuffer:!0,excelCopyBufferOptions:{onCopyCells:(l,t)=>console.log("onCopyCells",l,t),onPasteCells:(l,t)=>console.log("onPasteCells",l,t),onCopyCancelled:(l,t)=>console.log("onCopyCancelled",l,t)},enableCellNavigation:!0,gridHeight:275,headerButton:{onCommand:(l,t)=>this.handleOnCommand(l,t,1)}},this.gridOptions2=C(x({},this.gridOptions1),{enableHeaderMenu:!0,enableFiltering:!0,headerButton:{onCommand:(l,t)=>this.handleOnCommand(l,t,2)}})}handleOnCommand(l,t,r){let a=t.column,o=t.button;t.command==="toggle-highlight"&&(o.cssClass==="mdi mdi-lightbulb-on text-danger"?(r===1?delete h[a.id]:delete g[a.id],o.cssClass="mdi mdi-lightbulb-outline text-warning faded",o.tooltip="Highlight negative numbers."):(r===1?h[a.id]=!0:g[a.id]=!0,o.cssClass="mdi mdi-lightbulb-on text-danger",o.tooltip="Remove highlight."),this[`angularGrid${r}`].slickGrid.invalidate())}loadData(l,t){for(let a=0;a<10;a++)this[`columnDefinitions${t}`].push({id:a,name:"Column "+String.fromCharCode(65+a),field:a+"",width:a===0?70:100,filterable:!0,sortable:!0,formatter:(o,s,d,f)=>t===1&&h[f.id]&&d<0?`<div style="color:red; font-weight:bold;">${d}</div>`:t===2&&g[f.id]&&d<0?`<div style="color:red; font-weight:bold;">${d}</div>`:d,header:{buttons:[{cssClass:"mdi mdi-lightbulb-outline text-warning faded",command:"toggle-highlight",tooltip:"Highlight negative numbers.",itemVisibilityOverride:o=>o.column.name!=="Column E",itemUsabilityOverride:o=>o.column.name!=="Column J",action:(o,s)=>{console.log(`execute a callback action to "${s.command}" on ${s.column.name}`)}}]}});this[`columnDefinitions${t}`][0].name="Resize me!",this[`columnDefinitions${t}`][0].header={buttons:[{cssClass:"mdi mdi-message-text",handler:()=>{alert("Tag")}},{cssClass:"mdi mdi-forum-outline",handler:()=>{alert("Comment")}},{cssClass:"mdi mdi-information",handler:()=>{alert("Info")}},{cssClass:"mdi mdi-help-circle",handler:()=>{alert("Help")}}]},t===2&&this.columnDefinitions2[0].header?.buttons?.reverse(),this[`columnDefinitions${t}`][1].name="Hover me!",this[`columnDefinitions${t}`][1].header={buttons:[{cssClass:"mdi mdi-help-circle",showOnHover:!0,tooltip:"This button only appears on hover.",handler:()=>{alert("Help")}}]};let r=[];for(let a=0;a<l;a++){let o=r[a]={};o.id=a;for(let s=0;s<this[`columnDefinitions${t}`].length;s++)o[s]=Math.round(Math.random()*10)-5}return r}toggleSubTitle(){this.hideSubTitle=!this.hideSubTitle;let l=this.hideSubTitle?"add":"remove";document.querySelector(".subtitle")?.classList[l]("hidden"),this.angularGrid2.resizerService.resizeGrid(0)}static{this.\u0275fac=function(t){return new(t||m)}}static{this.\u0275cmp=y({type:m,selectors:[["ng-component"]],decls:71,vars:6,consts:[["id","demo-container",1,"container-fluid"],[1,"float-end"],["target","_blank","href","https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example07.component.ts",2,"font-size","18px"],[1,"mdi","mdi-link-variant"],["type","button","data-test","toggle-subtitle",1,"ms-2","btn","btn-outline-secondary","btn-sm","btn-icon",3,"click"],["title","Toggle example sub-title details",1,"mdi","mdi-information-outline"],[1,"subtitle"],["href","https://ghiscoding.gitbook.io/angular-slickgrid/grid-functionalities/header-menu-and-header-buttons","target","_blank"],["gridId","grid7-1",3,"onAngularGridCreated","columns","options","dataset"],["gridId","grid7-2",3,"onAngularGridCreated","columns","options","dataset"]],template:function(t,r){t&1&&(i(0,"div",0),e(1,`
  ...
  `),n(),e(69,`
`),n(),e(70,`
`)),t&2&&(p(57),b("columns",r.columnDefinitions1)("options",r.gridOptions1)("dataset",r.dataset1),p(10),b("columns",r.columnDefinitions2)("options",r.gridOptions2)("dataset",r.dataset2))},dependencies:[v],styles:[`#grid7-1{--slick-header-button-float: right}#grid7-2{--slick-header-button-margin: 4px 0 50px 0;--slick-header-button-float: left}
/*# sourceMappingURL=example07.component-ITD7ECKN.css.map */
`],encapsulation:2})}}return m})();export{k as Example7Component};
//# sourceMappingURL=example07.component-DTNI6XMP.js.map
