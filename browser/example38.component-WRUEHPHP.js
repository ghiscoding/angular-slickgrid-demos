import{a as U}from"./chunk-MKRYXBUI.js";import{c as Q}from"./chunk-KU7SEVC4.js";import{Da as j,ja as q,n as W,wa as F,xa as V}from"./chunk-37LE67SH.js";import{Aa as p,Jb as R,Ka as $,Kb as e,Lb as _,Mb as O,Pa as B,_b as Z,ac as H,db as I,eb as z,ia as y,ib as D,jb as n,kb as i,lb as E,vb as v,xa as P,xb as L}from"./chunk-M6IC3X47.js";import{a as A}from"./chunk-JQGRFILQ.js";function K(f,J){if(f&1&&(e(0,`
        `),n(1,"div",23),e(2,`
...
`)),d&2){let l,h;p(49),z(a.errorStatus()?49:-1),p(7),R((l=a.status())==null?null:l.class),p(4),O(" ",(h=a.status())==null?null:h.text,`
        `),p(),D("hidden",!a.processing()),p(15),_(a.odataQuery()),p(23),z(a.metrics()?99:-1),p(3),D("columns",a.columnDefinitions)("options",a.gridOptions)("dataset",a.dataset)}},dependencies:[j,W],styles:[`.demo38 .badge{display:none}.demo38 .badge.fully-loaded{display:inline-flex}
/*# sourceMappingURL=example38.component-W3FE6Z43.css.map */
`],encapsulation:2})}}return f})();export{me as Example38Component};
//# sourceMappingURL=example38.component-WRUEHPHP.js.map
