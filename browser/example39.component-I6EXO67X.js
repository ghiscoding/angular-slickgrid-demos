import{a as ee}from"./chunk-IE2EICZM.js";import{b as j,c as U,f as Y,h as Z,o as $}from"./chunk-3N25H53U.js";import{c as V}from"./chunk-KU7SEVC4.js";import{Ca as X,Da as q,n as K,u as J,wa as w}from"./chunk-37LE67SH.js";import{Aa as m,Jb as k,Ka as M,Kb as e,Lb as E,Mb as T,Pa as R,Pb as B,Qb as Q,Rb as P,_b as O,ac as H,db as z,eb as F,ia as x,ib as v,jb as i,kb as n,lb as h,vb as b,xa as N,xb as W}from"./chunk-M6IC3X47.js";import{a as D}from"./chunk-JQGRFILQ.js";function oe(p,me){if(p&1&&(e(0,`
        `),i(1,"div",25),e(2,`
  ...
  `),n(),e(111,`
`),n(),e(112,`
`)),l&2){let r,s;m(49),k((r=a.status())==null?null:r.class),m(4),T(" ",(s=a.status())==null?null:s.text,`
        `),m(),v("hidden",!a.processing()),m(18),B("ngModel",a.serverWaitDelay),m(17),T(`
            `,a.selectedLanguage()+".json",`
          `),m(6),F(a.metrics()?95:-1),m(9),v("innerHTML",a.graphqlQuery,N),m(5),v("columns",a.columnDefinitions)("options",a.gridOptions)("dataset",a.dataset)}},dependencies:[q,$,j,Z,U,Y,K],styles:[`.demo39 .badge{display:none}.demo39 .badge.fully-loaded{display:inline-flex}
/*# sourceMappingURL=example39.component-56HWSDJG.css.map */
`],encapsulation:2})}}return p})();export{Ee as Example39Component};
//# sourceMappingURL=example39.component-I6EXO67X.js.map
