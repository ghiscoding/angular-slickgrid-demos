import{b as M,c as k,f as v,j as w,k as T,l as D,o as G}from"./chunk-3N25H53U.js";import{Da as V,za as u}from"./chunk-37LE67SH.js";import{Aa as d,Kb as e,Lb as b,Pa as E,Pb as h,Qb as g,Rb as f,fb as _,gb as S,hb as C,ib as p,jb as t,kb as n,lb as c,vb as m}from"./chunk-M6IC3X47.js";import"./chunk-JQGRFILQ.js";function F(s,x){if(s&1&&(e(0,`
  ...
  `),n(),e(75,`
`),n(),e(76,`
`)),r&2&&(d(43),h("ngModel",i.selectedColumn),d(2),C(i.columnDefinitions),d(6),h("ngModel",i.selectedOperator),d(2),C(i.operatorList),d(8),h("ngModel",i.searchValue),d(12),p("columns",i.columnDefinitions)("options",i.gridOptions)("dataset",i.dataset))},dependencies:[V,G,T,D,M,w,k,v],styles:[`#grid21 .slick-header-column:last-child .slick-header-menu-button,#grid21 .slick-header-column:last-child .slick-resizable-handle,#grid21 .slick-header-column:last-child .slick-sort-indicator,#grid21 .slick-header-column:last-child .slick-sort-indicator-numbered{margin-right:18px}.duration-bg{background-color:#e9d4f1!important}
/*# sourceMappingURL=example21.component-M5BZMWNH.css.map */
`],encapsulation:2})}}return s})();export{B as Example21Component};
//# sourceMappingURL=example21.component-P75RB2U3.js.map
