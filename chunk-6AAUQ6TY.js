...
`),i(),e(90,`
`)),l&2&&(g(75),k(a.selectedLanguage()+".json"),g(3),C(a.statusClass()),g(5),w("textContent",a.fetchResult()),g(5),w("columns",a.columnDefinitions)("options",a.gridOptions)("dataset",a.dataset))},dependencies:[v],styles:[`.alert{padding:8px;margin-bottom:10px}.status-container{min-height:50px}
