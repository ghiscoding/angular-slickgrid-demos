import {Z as Ze}from'./chunk-6W1Wahwc.js';import {r}from'./chunk-DnY-KoaL.js';import {D,L as Le,d as ji,e as Tu,X as XN,_ as _I,j as j1,H as Hp,u as ui,q as qE,c as cp,T as Tc,p as pp,Y as YI,W as Wy,K as KI,a as ap,g as cD,h as pE,m as xp,n as dD}from'./main-MYLFMRPB.js';function H(l,S){if(l&1&&(qE(0,`
  ...
  `),Tc(),qE(17,`
  `),ui(18,"div",6),qE(19,`
    Sort/Filter on client side only using SlickGrid DataView (`),ui(20,"a",7),qE(21,"Wiki docs"),Tc(),qE(22,`)
    `),cp(23,"br"),qE(24,`
    `),ui(25,"ul",8),qE(26,`
      `),ui(27,"li"),qE(28,'Support multi-sort (by default), hold "Shift" key and click on the next column to sort.'),Tc(),qE(29,`
      `),ui(30,"li"),qE(31,"All column types support the following operators: (>, >=, <, <=, <>, !=, =, ==, *)"),Tc(),qE(32,`
      `),ui(33,"ul"),qE(34,`
        `),ui(35,"li"),qE(36,"Example: >100 ... >=2001-01-01 ... >02/28/17"),Tc(),qE(37,`
        `),ui(38,"li"),qE(39,`
          `),ui(40,"b"),qE(41,"Note:"),Tc(),qE(42,` For filters to work properly (default is string), make sure to provide a FieldType (type is against the dataset, not
          the Formatter)
        `),Tc(),qE(43,`
      `),Tc(),qE(44,`
      `),ui(45,"li"),qE(46,"Date Filters"),Tc(),qE(47,`
      `),ui(48,"ul"),qE(49,`
        `),ui(50,"li"),qE(51,`
        ...
        `),Tc(),qE(52,`
      `),Tc(),qE(53,`
      `),ui(54,"li"),qE(55,'On String filters, (*) can be used as startsWith (Hello* => matches "Hello Word") ... endsWith (*Doe => matches: "John Doe")'),Tc(),qE(56,`
      `),ui(57,"li"),qE(58,`
        Custom Filter are now possible, "Description" column below, is a customized InputFilter with different placeholder. See
        `),ui(59,"a",9),qE(60,"Wiki - Custom Filter"),Tc(),qE(61,`
      `),Tc(),qE(62,`
      `),ui(63,"li"),qE(64,'MultipleSelect & SingeSelect Filters can use a regular "collection" or "collectionAsync" to load it asynchronously'),Tc(),qE(65,`
    `),Tc(),qE(66,`
  `),Tc(),qE(67,`

  `),cp(68,"br"),qE(69,`
  `),YI(70,H,8,6),ui(71,"div",10),qE(72,`
    `),ui(73,"button",11),pp("click",function(){return r.scrollGridTop()}),qE(74,`
      `),cp(75,"i",12),qE(76,`
    `),Tc(),qE(77,`
    `),ui(78,"button",13),pp("click",function(){return r.scrollGridBottom()}),qE(79,`
      `),cp(80,"i",14),qE(81,`
    `),Tc(),qE(82,`
  `),Tc(),qE(83,`
  `),ui(84,"button",15),pp("click",function(){return r.angularGrid.filterService.clearFilters()}),qE(85,`
    Clear Filters
  `),Tc(),qE(86,`
  `),ui(87,"button",16),pp("click",function(){return r.angularGrid.sortService.clearSorting()}),qE(88,`
    Clear Sorting
  `),Tc(),qE(89,`
  `),ui(90,"button",17),pp("click",function(){return r.setFiltersDynamically()}),qE(91,`
    Set Filters Dynamically
  `),Tc(),qE(92,`
  `),ui(93,"button",18),pp("click",function(){return r.setSortingDynamically()}),qE(94,`
  ...
  `),Tc(),qE(98,`
`),Tc(),qE(99,`
`)),a&2&&(Wy(70),KI(r.metrics?70:-1),Wy(26),ap("columns",r.columns)("options",r.gridOptions)("dataset",r.dataset));},dependencies:[j1,Hp],encapsulation:2});}}return l})();export{X as Example4Component};