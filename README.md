...
## Multiple Demos of the [Angular-Slickgrid](https://github.com/slickgrid-stellar/Angular-Slickgrid) library
#### Previous Version 2.x Reference
In case you need to refer to the previous 2.x demo code, a tag was created before releasing the new `major 3.x` version, so here's the [2.30.2 tag](https://github.com/slickgrid-stellar/angular-slickgrid-demos/tree/v2.30.2) link.
...
For a full compatibility table of Angular-Slickgrid with Slickgrid-Universal, you can consult the [Versions Compatibility Table - Wiki](https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/Versions-Compatibility-Table)
