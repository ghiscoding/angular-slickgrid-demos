...
import { AngularGridInstance, Column, Editors, Filters, Formatters, GridOption, SlickRowDetailView } from 'angular-slickgrid';
  ...
  defineGrid() {
    ...
    this.gridOptions = {
      ...
      rowDetailView: {
        ...
        viewComponent: Example19RowDetailComponent,
