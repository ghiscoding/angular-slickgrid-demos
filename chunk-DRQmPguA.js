import {M as MM,X as XN,x as xi,bh as $,_ as _I,j as j1,u as ui,q as qE,c as cp,T as Tc,p as pp,ap as Jf,W as Wy,a as ap,au as fD}from'./main-MR3B775B.js';function v(d,w){d&1&&(qE(0,`
  ...
  `),ui(18,"h6",7),qE(19,`
    `),ui(20,"ul"),qE(21,`
      `),ui(22,"li"),qE(23,"Click to select, Ctrl-click to toggle selection(s)."),Tc(),qE(24,`
      `),ui(25,"li"),qE(26,"Drag one or more rows by the handle icon to reorder."),Tc(),qE(27,`
      `),ui(28,"li"),qE(29,"Drag one or more rows by selection and drag to the recycle bin to delete."),Tc(),qE(30,`
    `),Tc(),qE(31,`
  `),Tc(),qE(32,`
  ...
  `),ui(33,"div",8),qE(34,`
    `),ui(35,"div",9),qE(36,`
      `),ui(37,"div",10),qE(38,`
        `),ui(39,"angular-slickgrid",11),pp("onAngularGridCreated",function(o){return n.angularGridReady(o.detail)})("onDragInit",function(o){return n.handleOnDragInit(o.detail.eventData)})("onDragStart",function(o){return n.handleOnDragStart(o.detail.eventData)})("onDrag",function(o){return n.handleOnDrag(o.detail.eventData,o.detail.args)})("onDragEnd",function(o){return n.handleOnDragEnd(o.detail.eventData,o.detail.args)}),qE(40,`
          `),Jf(41,v,7,0,"ng-template",null,0,fD),qE(43,`
        `),Tc(),qE(44,`
      `),Tc(),qE(45,`
    `),Tc(),qE(46,`

    `),ui(47,"div",9),qE(48,`
      `),ui(49,"div",12),qE(50,"Recycle Bin"),Tc(),qE(51,`
    `),Tc(),qE(52,`
  `),Tc(),qE(53,`
`),Tc(),qE(54,`
