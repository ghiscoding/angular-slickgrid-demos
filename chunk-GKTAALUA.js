import{Da as G,wa as g,za as m}from"./chunk-V3K67AAF.js";import{$ as x,Jb as e,Oa as C,_ as f,cb as k,db as E,hb as p,ia as h,ib as i,jb as n,kb as d,rb as T,ub as s,wa as b,wb as S,za as c}from"./chunk-CCOLL5XZ.js";import"./chunk-PRARYYF3.js";function y(u,w){if(u&1){let a=T();e(0,`
        `),i(1,"span",25),e(2,`
          `),i(3,"div",10),e(4,`
  ...
  `),n(),e(102,`
`),n(),e(103,`
`)),o&2&&(c(64),p("innerHTML",t.selectedTitle(),b),c(7),p("columns",t.columns1)("options",t.gridOptions1)("dataset",t.dataset1),c(10),p("checked",t.isGrid2WithPagination),c(2),E(t.isGrid2WithPagination?83:-1),c(9),p("innerHTML",t.selectedTitles(),b),c(7),p("columns",t.columns2)("options",t.gridOptions2)("dataset",t.dataset2))},dependencies:[G],styles:[".alert[_ngcontent-%COMP%]{padding:8px;margin-bottom:10px}",".col-sm-1[_ngcontent-%COMP%]{max-width:70px}"]})}}return u})();export{R as Example10Component};
