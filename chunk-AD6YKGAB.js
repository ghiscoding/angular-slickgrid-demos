...
`)),r&2&&(g(9),k(" ",e.currentPagination==null?null:e.currentPagination.dataFrom," "),g(3),k(`
  ...
  `),d(),t(42,`
`),d(),t(43,`
`)),r&2&&(g(36),I("ngModel",e.pageSize),g(4),F("columns",e.columnDefinitions)("options",e.gridOptions)("dataset",e.dataset))},dependencies:[j,A,R,W,G],encapsulation:2})}}return s})();export{X as Example42Component};
